...
class Cetba_controller extends CI_Controller {
	...
	public function form_validation(){
		...
		$this->form_validation->set_rules("autor", "Autor Knihy", 'required');  
		$this->form_validation->set_rules("nazev", "Nazev Knihy", 'required');
		$this->form_validation->set_rules("pocet_stranek", "Pocet Stranek", 'required');
		$this->form_validation->set_rules("prebal", "Přebal Knihy", 'required');
		$this->form_validation->set_rules("anotace", "Anotace", 'required');  
		if($this->form_validation->run())  
		{  
			 //true  
			 $this->load->model("Cetba_model");  
			 $data = array(  
				"autor_knihy"=>$this->input->post('autor'),
				"nazev_knihy"=>$this->input->post('nazev'),
				"pocet_stranek"=>$this->input->post('pocet_stranek'),
				"prebal"=>$this->input->post('prebal'),
				"anotace"=>$this->input->post('anotace'),
			 );  
			 ...
			 {  
				  ...
				  redirect(base_url() . "Cetba_controller/inserted");  
			 }  
		}  
		else  
		{  
